...
public class Manager extends InventoryManager
{
    ...
    public static Employee createAnEmployee(String name, String accountNumber, int salary, String address, String phoneNumber, String employeeID, String password)
    {
      /* if (loggedIn)
       {*/
